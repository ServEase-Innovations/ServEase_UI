...
santhali: {
  ...
  perfectAvailabilityDescription: {
    en: "Available at their preferred time every day in the next 30 days, with no schedule conflicts.",
    hi: "अगले 30 दिनों में हर दिन अपने पसंदीदा समय पर उपलब्ध, बिना किसी कार्यक्रम विरोध के।",
    kn: "ಮುಂದಿನ 30 ದಿನಗಳಲ್ಲಿ ಪ್ರತಿ ದಿನ ಆದ್ಯತೆಯ ಸಮಯದಲ್ಲಿ ಲಭ್ಯವಿದೆ, ಯಾವುದೇ ವೇಳಾಪಟ್ಟಿ ಸಂಘರ್ಷವಿಲ್ಲ.",
    bn: "পরবর্তী ৩০ দিনে প্রতিদিন পছন্দের সময়ে উপলব্ধ, কোনো সময়সূচির দ্বন্দ্ব নেই।"
  },
  whyNotBestMatch: {
  ...
  previouslyBooked: {
    en: "Booked before",
    hi: "पहले बुक किया",
    kn: "ಹಿಂದೆ ಬುಕ್ ಮಾಡಲಾಗಿದೆ",
    bn: "আগে বুক করা হয়েছে"
  },
  PreviouslyBooked: {
    en: "Booked before",
    hi: "पहले बुक किया",
  ...
  previousBooking: {
    en: "Your previous booking",
    hi: "आपकी पिछली बुकिंग",
    kn: "ನಿಮ್ಮ ಹಿಂದಿನ ಬುಕಿಂಗ್",
    bn: "আপনার আগের বুকিং"
  },
  previousBookingMessage: {
    en: "You have booked this provider before. Expanding the details can help you decide if they are a good fit again.",
    hi: "आपने पहले इस प्रदाता को बुक किया है। विवरण देखने से यह तय करने में मदद मिलती है कि वे फिर से उपयुक्त हैं या नहीं।",
    kn: "ನೀವು ಈ ಪ್ರದಾತಾವನ್ನು ಹಿಂದೆ ಬುಕ್ ಮಾಡಿದ್ದೀರಿ. ವಿವರಗಳನ್ನು ನೋಡುವುದರಿಂದ ಅವರು ಮತ್ತೆ ಸೂಕ್ತರಾಗಿದ್ದಾರೆಯೇ ಎಂದು ನಿರ್ಧರಿಸಲು ಸಹಾಯವಾಗುತ್ತದೆ.",
    bn: "আপনি আগে এই প্রদানকারীকে বুক করেছেন। বিবরণ দেখলে তারা আবার উপযুক্ত কিনা তা বুঝতে সাহায্য করে।"
  },
  showDetails: {
    en: "Show details",
    hi: "विवरण देखें",
  ...
  availabilityProgressLabel: {
    en: "{available} of {total} days at preferred time",
    hi: "पसंदीदा समय पर {total} में से {available} दिन",
    kn: "ಆದ್ಯತೆಯ ಸಮಯದಲ್ಲಿ {total} ದಿನಗಳಲ್ಲಿ {available} ದಿನ",
    bn: "পছন্দের সময়ে {total} দিনের মধ্যে {available} দিন"
  },
  calendarDaysInWindow: {
    en: "Days in booking window",
    hi: "बुकिंग अवधि के दिन",
    kn: "ಬುಕಿಂಗ್ ವಿಂಡೋದಲ್ಲಿನ ದಿನಗಳು",
    bn: "বুকিং সময়সীমার দিন"
  },
  availabilityStrongMatch: {
    en: "Strong availability for your dates",
    hi: "आपकी तारीखों के लिए अच्छी उपलब्धता",
    kn: "ನಿಮ್ಮ ದಿನಾಂಕಗಳಿಗೆ ಉತ್ತಮ ಲಭ್ಯತೆ",
    bn: "আপনার তারিখের জন্য ভাল উপলব্ধতা"
  },
...
timeHourRestriction: {
  en: "Start time must be between 6:00 AM and 7:00 PM (service ends by 8:00 PM)",
  hi: "শুরুর সময় সকাল ৬:০০ থেকে সন্ধ্যা ৭:০০ এর মধ্যে হতে হবে (সেবা রাত ৮:০০ পর্যন্ত)",
  kn: "ಪ್ರಾರಂಭ ಸಮಯ ಬೆಳಿಗ್ಗೆ 6:00 ಮತ್ತು ಸಂಜೆ 7:00 ರ ನಡುವೆ ಇರಬೇಕು (ಸೇವೆ 8:00 ಗೆ ಮುಕ್ತಾಯ)",
  bn: "শুরুর সময় সকাল ৬:০০ থেকে সন্ধ্যা ৭:০০ এর মধ্যে হতে হবে (সেবা রাত ৮:০০ পর্যন্ত)"
},
