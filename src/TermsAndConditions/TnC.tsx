        ...
        <Container maxWidth="md" sx={{ py: 4 }}>
            <Paper elevation={3} sx={{ p: 4 }}>
                ...
                <List dense>
                    ...
                    <ListItem>
                        <ListItemText
                            primary="• 'Agreement': Refers to these Terms and Conditions."
                        />
                    </ListItem>
                </List>
                ...
                <Box sx={{ mt: 4, p: 2, backgroundColor: '#fff8e1', borderRadius: 1 }}>
                    ...
                    <Typography variant="body2" component="div">
                        <ul>
                            <li>Local Labor Laws: Extremely critical for employment status, working hours, rest breaks, and termination procedures.</li>
