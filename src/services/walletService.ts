...
/** Shorter label for list rows (e.g. "Payment for booking #171" → "Booking #171"). */
...
export interface WalletTransactionGroup {
  key: string;
  labelKey: "walletToday" | "walletYesterday" | "walletEarlier";
  dateLabel?: string;
...
/**
 * Full wallet top-up: create order → Razorpay checkout → verify → credit wallet.
 */
