...
const NannyServicesDialog = ({ open, handleClose }) => {
  ...
  // State for elderly care packages
  ...
  // Handle age change for baby care
  const handleBabyAgeChange = (packageType, value) => {
  ...
  // Handle age change for elderly care
  const handleElderlyAgeChange = (packageType, value) => {
